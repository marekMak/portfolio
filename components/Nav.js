...
const Nav = () => {
  ...
  return (
    <nav className="flex flex-col items-center xl:justify-center gap-y-4 fixed h-max bottom-0 mt-10 xl:right-[2%] z-50 bottom-0 w-full xl:w-16 xl:max-w-md xl:h-screen">
      {/* inner */}
      <div
          ...
          return (
            ...
            >
              ...
              <div className="absolute pr-14 right-0 hidden xl:group-hover:flex">
                <div className="bg-white relative w-24 flex text-primary flex items-center p-[6px] rounded-[3px]">
                  <div className="text-[12px] font-semibold pl-2">
                    {link.name}
                  </div>
                  {/* triangle */}
