...
export const getStaticProps = async () => {
  const res = await fetch(
    "https://baro.ibasterisk.sk/wp-json/wp/v2/posts?categories=34&per_page=100"
  );
...
const Virtualizacia = ({ data }) => {
  ...
  return (
    <div className="container mx-auto h-auto flex flex-col items-center py-20">
      <motion.h1
